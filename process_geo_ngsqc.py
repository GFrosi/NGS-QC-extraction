...
def parse_html(file_html):
    ...
    # file = open('/Users/gfrosi/Documents/Frosi_lab_jacques/re-analysis-Chip-Seq-2020/frosi-JF-query-2020/NGS-QC_to_git/Homo_sapiens_ngs.html','r') #in this case, it was necessary open the file to apply BeautifulSoup.
